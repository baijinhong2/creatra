...
{"angle":"具体角度(1-2 句话)","type":"single|thread|image|video","topic":"主题一句话","reasoning":"为什么这个角度适合今天(必须引用至少 1 个具体依据:热点/对标/项目)","bestTime":"建议发布时段","hook":"开头 hook","imagePrompt":"英文 AI 生图 prompt(type=image 时填)","tags": ["#hashtag1","#hashtag2"]
}
