...
const ALLOWED_SCOPES = new Set(['account','voice','projects','insights','tools','episodic',
]);
...
function inferScope(key: string): string {
 ...
 if (['account.niche','account.positioning','target.audience','differentiation','content.sources','brand.username','brand.bio','brand.avatar','brand.banner','watchlist','track.competitors','x.handle',
