...
const TEXT_EXTS = new Set(['txt','md','markdown','rst','py','js','jsx','ts','tsx','mjs','cjs','css','scss','less','html','htm','xml','svg','json','yml','yaml','toml','ini','conf','cfg','env','sh','bash','zsh','fish','ps1','sql','graphql','gql','csv','tsv','log','mdx','vue','svelte','rb','pyi','go','rs','java','kt','c','h','cpp','hpp','cs','php','swift','m','mm',
]);
